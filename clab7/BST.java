...
public class BST<Key extends Comparable<Key>> {
    ...
    public double AverageDepth(){
        return (double)(1.0*TotalDepth()/size());
    }

    /*
    * Returns the total depth of BST
    */
    public int TotalDepth(){
            return TotalDepth(root,0);
    }

    /* return total depth of BST whose root is T*/
    private int TotalDepth(Node T,int depth){
        if(T == null){
            return depth-1;
        } else{
            if(T.left == null && T.right == null){
                ...
                return depth+TotalDepth(T.right,depth+1);
            } else if(T.right == null){
                return depth + TotalDepth(T.left,depth+1);
            } else{
    ...
    /*
     * Returns the max Height of BST whose root is T
     */
