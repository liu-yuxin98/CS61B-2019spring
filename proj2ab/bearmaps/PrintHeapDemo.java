...
//        minPQ1.add(7,7.0);
//        minPQ1.add(9,9.0);
//        minPQ1.changePriority(9,1);
//       Integer[] example = new Integer[minPQ1.size()+1];
//        for(int i=1;i< example.length;i++){
//            int item = minPQ1.heap.get(i).getItem();
//            example[i] = item;
//        }
//        minPQ1.printitems();
...
//        for(int j=1;j< 10;j++){
//            minPQ1.removeSmallest();
//            example = new Integer[minPQ1.size()+1];
//            for(int i=1;i< example.length;i++){
//                int item = minPQ1.heap.get(i).getItem();
//                example[i] = item;
//            }
